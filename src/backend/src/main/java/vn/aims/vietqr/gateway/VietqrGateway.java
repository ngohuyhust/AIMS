package vn.aims.vietqr.gateway;

import vn.aims.vietqr.client.VietqrApiClient;
import vn.aims.vietqr.repository.VietqrStore;
...
public class VietqrGateway implements QrCodeGateway {
    ...
    public void prepare(GatewayRequest request) {
    ...
    public VietqrStore.Row required(int id) {var row=store.byPayment(id);if(row==null) throw new PaymentException(404,"VietQR payment "+id+" was not found");return row;}
    ...
    public JsonNode response(VietqrStore.Row row) {
