...
public class VietqrApiClient {
    ...
    public void configured() {if(username.isBlank() || password.isBlank() || bankCode.isBlank() || bankAccount.isBlank() || bankName.isBlank()) throw new PaymentException(400,"VietQR API credentials or bank account configuration are missing");}
    ...
    public JsonNode generate(int orderId,BigDecimal amount,String content) {
    ...
    public void trigger(String content,BigDecimal amount) {
