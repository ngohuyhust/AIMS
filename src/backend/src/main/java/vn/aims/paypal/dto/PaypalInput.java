package vn.aims.paypal.dto;

import com.fasterxml.jackson.databind.JsonNode;
import java.util.*;
import vn.aims.payment.exception.PaymentException;

public final class PaypalInput {
    public record Input(int orderID,String paypalOrderID) {}
    ...
    public static Input parse(JsonNode body,String operation) {
