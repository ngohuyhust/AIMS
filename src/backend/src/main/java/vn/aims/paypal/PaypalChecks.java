...
final class PaypalChecks {
    static String usd(BigDecimal vnd) { return vnd.divide(new BigDecimal("25000"),2,RoundingMode.HALF_UP).toPlainString(); }
    ...
    static void amount(JsonNode amount,BigDecimal vnd) {
        try {
    ...
    static void order(JsonNode data,int orderId,BigDecimal amount,String gatewayId) {
    ...
    static boolean captured(JsonNode data) {
    ...
    static String capture(JsonNode data,int orderId,BigDecimal amount,String gatewayId) {
