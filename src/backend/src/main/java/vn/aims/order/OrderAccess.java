...
public class OrderAccess {
    ...
    void require(Order order,int id,String token,boolean manager) {
        ...
        if(order==null || order.customerAccessToken==null || !MessageDigest.isEqual(order.customerAccessToken.getBytes(StandardCharsets.UTF_8),token.getBytes(StandardCharsets.UTF_8)))
