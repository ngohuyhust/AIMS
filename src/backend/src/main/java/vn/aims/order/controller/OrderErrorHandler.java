...
public class OrderErrorHandler {
    ...
    @ExceptionHandler(vn.aims.payment.exception.PaymentException.class)
    ResponseEntity<?> payment(vn.aims.payment.exception.PaymentException e) { return error(new OrderError(e.status(),e.getMessage())); }
