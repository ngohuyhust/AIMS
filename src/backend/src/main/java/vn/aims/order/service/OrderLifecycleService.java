...
import vn.aims.order.event.OrderLifecycleEvent;
...
import vn.aims.order.repository.*;
import vn.aims.notification.event.NotificationRequested;
...
public class OrderLifecycleService {
    ...
    public Map<String,Object> approve(int id) {
        return transaction(()->{
    ...
    @PreAuthorize("#customer or hasAuthority('PRODUCT_MANAGER')")
    public Map<String,Object> close(int id,String action,String token,boolean customer) {
    ...
    @PreAuthorize("hasAuthority('PRODUCT_MANAGER')")
    public Map<String,Object> confirmVietqrRefund(int id) {
        return transaction(()->{
