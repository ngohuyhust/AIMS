...
public class SendGridEmailProvider implements NotificationProvider {
    ...
    SendGridEmailProvider(EmailTemplateService templates,SendGrid client) {this.templates=templates;sendgrid=client;http=null;key="synthetic-key";from="sender@example.test";name="AIMS Store";enabled=true;}
    @jakarta.annotation.PreDestroy void close() throws java.io.IOException {if(http!=null)http.close();}
