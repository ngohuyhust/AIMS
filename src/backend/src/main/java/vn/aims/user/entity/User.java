...
public class User {
    ...
    public void updateProfile(String email,String fullName,String phoneNumber) {
        this.email=email;this.fullName=fullName;this.phoneNumber=phoneNumber;
    }
    public void changeStatus(String status) { this.status=status; }
    public void replaceRoles(Collection<Role> replacements) { roles.clear(); roles.addAll(replacements); }
}
