package vn.aims.payment.service;

import vn.aims.payment.dto.PaymentConfirmation;
import vn.aims.payment.dto.PaymentView;
import vn.aims.payment.event.PaymentConfirmed;
...
import vn.aims.payment.repository.PaymentRepository;
...
public class PaymentService {
    ...
    public boolean confirm(PaymentConfirmation proof) {
        ...
        events.publishEvent(new NotificationRequested("ORDER_PAYMENT_SUCCEEDED",order.id(),payment.transactionID(),null,null));
