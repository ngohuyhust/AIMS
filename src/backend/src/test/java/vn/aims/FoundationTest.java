...
class FoundationTest {
    ...
    void flywayRunsOnPostgresqlAndCanBeRepeatedWithOnlyAuthorizedTables() {
        ...
        assertThat(jdbc.queryForList("""
                ...
                """, String.class)).containsExactly("books", "cd_tracks", "cds", "delivery_info", "dvds", "flyway_schema_history", "invoices", "media", "newspapers", "notification_outbox", "order_items", "order_lifecycle_operations", "orders", "payment_transactions", "paypal_operations", "paypal_transactions", "product_logs", "products", "roles", "user_audit_logs", "users", "users_roles", "vietqr_receipts", "vietqr_transactions");
    }
