...
class FoundationTest {
    ...
    void flywayRunsOnPostgresqlAndCanBeRepeatedWithOnlyAuthorizedTables() {
        ...
        assertThat(jdbc.queryForList("""
                ...
                """, String.class)).containsExactly("books", "cd_tracks", "cds", "delivery_info", "dvds", "flyway_schema_history", "invoices", "media", "newspapers", "order_items", "orders", "payment_transactions", "product_logs", "products", "roles", "user_audit_logs", "users", "users_roles");
    }
